...
symbols_get = session.get('https://' + MT5_SERVER + '/api/symbol/list')
print(symbols_get.json().get('answer'))
...
if retcode == "0 Done" and len(answer) != 0:
    ...
    logging.error('Can\'t get the count of symbols' + str(symbols_total.status_code))
    exit()
